 ...
 */
final class Version20210301180439 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE livraison (id INT AUTO_INCREMENT NOT NULL, livreur_id INT NOT NULL, commande_id INT NOT NULL, date_livraison DATETIME NOT NULL, adresse_livraison VARCHAR(255) NOT NULL, status VARCHAR(20) NOT NULL, INDEX IDX_A60C9F1FF8646701 (livreur_id), UNIQUE INDEX UNIQ_A60C9F1F82EA2E54 (commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE livreur (id INT AUTO_INCREMENT NOT NULL, type_vehicule VARCHAR(15) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE plats (id INT AUTO_INCREMENT NOT NULL, categorie_plats_id INT NOT NULL, restaurant_id INT NOT NULL, name VARCHAR(30) NOT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_854A620A9293A0A2 (categorie_plats_id), INDEX IDX_854A620AB1E7706E (restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE restaurant (id INT AUTO_INCREMENT NOT NULL, company_name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, ville_id INT NOT NULL, restaurant_id INT DEFAULT NULL, livreur_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, adress VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649A73F0036 (ville_id), UNIQUE INDEX UNIQ_8D93D649B1E7706E (restaurant_id), UNIQUE INDEX UNIQ_8D93D649F8646701 (livreur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ville (id INT AUTO_INCREMENT NOT NULL, secteur_id INT NOT NULL, nom_ville VARCHAR(70) NOT NULL, INDEX IDX_43C3D9C39F7E4405 (secteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE categorie_restaurant_restaurant ADD CONSTRAINT FK_F43B9739B2289124 FOREIGN KEY (categorie_restaurant_id) REFERENCES categorie_restaurant (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE categorie_restaurant_restaurant ADD CONSTRAINT FK_F43B9739B1E7706E FOREIGN KEY (restaurant_id) REFERENCES restaurant (id) ON DELETE CASCADE');
